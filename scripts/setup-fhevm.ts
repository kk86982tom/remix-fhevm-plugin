...
// Import FHEVM encryption functions
// import { initFhevm, encryptU32 } from '../src/fhevm';
...
async function encryptU32(value: number): Promise<Uint8Array> {
...
async function main(): Promise<void> {
  try {
    ...
    // TODO: Optionally write to .env file automatically
    console.log('\n💡 Note: This script does not automatically write to .env file for security');
    console.log('Please manually copy the values above to avoid overwriting existing configuration');
